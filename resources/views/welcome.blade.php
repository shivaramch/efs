...
@section('content')
    <div class="ticker">
        ...
        <iframe style='width: 100vw; height: 75px; position: relative'
                src='http://www.thefinancials.com/ShowPanel.aspx?pid=free&id=577&bgcolor=003366&fontcolor=ffffff&fontsize=13&bordercolor=c0c0c0&numtileswide=0&mode=iframe&scrollSpeedFromZeroToTen=5'
                scrolling='auto' marginheight='0' marginwidth='0' hspace='0' vspace='0' frameborder='no'
    ...
    <div class="links">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h2>Customer</h2>
                        <p>We see our success in our customers success, it gives us an immense pleasure when our advises
                            turn out to be fruitful. </p>
                        <p><a class="btn btn-default" href="{{ action('HomeController@index') }}" role="button">View
                                details &raquo;</a></p>
                    </div>
                </div>
            </div>
        ...
        <footer>
            ...
            <p style="text-align: center">Website Developed by <a
                        href="https://www.linkedin.com/in/shiva-ram-chennapragada-549a5258">Shiva Ram Chennapragada</a>
            </p>
        </footer>
    </div> <!-- /container -->
@endsection
